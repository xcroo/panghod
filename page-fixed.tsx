    ...
    <main className="min-h-screen bg-black text-white">
      ...
      <section className="max-w-6xl mx-auto px-6 py-20">
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          ...
          <div>
            ...
            <h1 className="text-7xl md:text-9xl font-black text-green-400">
              PANGO
            </h1>
          ...
          <div className="flex justify-center">
            ...
            <img
              ...
              w-[500px]
              max-w-full
              drop-shadow-[0_0_40px_rgba(0,255,120,0.4)]
              "
            />
      ...
      <section className="max-w-5xl mx-auto px-6 py-16">
        ...
        <div className="mt-8 text-gray-300 text-lg leading-8">
          ...
          <p className="mt-4">No complicated roadmap.</p>

          <p className="mt-4">No promises.</p>

          <p className="mt-4">No secret master plan.</p>

          <p className="mt-4">
            Just a pangolin trying its best.
          </p>
      ...
      <section className="max-w-5xl mx-auto px-6 py-16">
        ...
        <div className="mt-8 text-gray-300 text-lg leading-8">
          ...
          <p>
            One day a pangolin climbed a tree.
          </p>

          <p className="mt-4">
            The next day it had a ticker.
          </p>

          <p className="mt-4">
            Nobody remembers what happened in between.
          </p>
